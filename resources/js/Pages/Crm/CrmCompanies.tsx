...
const CrmCompanies = () => {
  ...
  const selectCRMState = (state: any) => state.Crm;
  ...
  const {
    companies, error
  }:any = useSelector(crmcompaniesData);
          ...
          return (
            <ul className="list-inline hstack gap-2 mb-0">
              ...
              <li className="list-inline-item" title="Edit">
                <Link className="edit-item-btn" href="#"
                    ...
                    <div className="flex-shrink-0">
                      <div className="hstack text-nowrap gap-2">
                        ...
                        <Dropdown>
                          <Dropdown.Toggle
                            href="#"
                            className="arrow-none btn btn-soft-info btn-icon"
                            as="button"
                          >
            ...
            <Col xxl={9}>
              <Card id="companyList">
                ...
                <Card.Body className="pt-0">
                  ...
                  <Modal id="showModal" show={modal} onHide={toggle} centered size="lg">
                    ...
                    <Form className="tablelist-form" onSubmit={(e) => {
                            ...
                            <div className="text-center">
                              <div className="position-relative d-inline-block">
                                <div className="position-absolute bottom-0 end-0">
                                  <Form.Label htmlFor="company-logo-input" className="mb-0">
                                  ...
                                  <Form.Control
                                    ...
                                    isInvalid={validation.touched.picture && validation.errors.picture ? true : false}
                                  />
                                </div>
                              ...
                              {validation.errors.picture && validation.touched.picture ? (
                                <Form.Control.Feedback type="invalid" className='d-block'> {validation.errors.picture} </Form.Control.Feedback>
                              ) : null}
                            </div>
                          </Col>
                          ...
                          <Col lg={6}>
                            <div>
                              ...
                              {validation.touched.owner && validation.errors.owner ? (
                                <Form.Control.Feedback type="invalid">{validation.errors.owner}</Form.Control.Feedback>
                              ) : null}
                            </div>
                          </Col>
                          <Col lg={6}>
                          ...
                          <Col lg={4}>
                            <div>
                              ...
                              {validation.touched.rating && validation.errors.rating ? (
                                <Form.Control.Feedback type="invalid">{validation.errors.rating}</Form.Control.Feedback>
                              ) : null}
                            </div>
                          </Col>
                          <Col lg={4}>
                          ...
                          <Col lg={4}>
                            <div>
                              ...
                              {validation.touched.employee && validation.errors.employee ? (
                                <Form.Control.Feedback type="invalid">{validation.errors.employee}</Form.Control.Feedback>
                              ) : null}
                            </div>
                          </Col>
                          <Col lg={6}>
                          ...
                          <Col lg={12}>
                            <div>
                              ...
                              {validation.touched.since && validation.errors.since ? (
                                <Form.Control.Feedback type="invalid">{validation.errors.since}</Form.Control.Feedback>
                              ) : null}
                            </div>
                          </Col>
                        </Row>
                      ...
                      <Modal.Footer>
                        <div className="hstack gap-2 justify-content-end">
                          ...
                          <Button type="submit" variant="success" id="add-btn" >  {!!isEdit ? "Update" : "Add Company"} </Button>
                        </div>
                      </Modal.Footer>
                    </Form>
                  </Modal>

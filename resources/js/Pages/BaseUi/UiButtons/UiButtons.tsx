                            ...
                            <Card>
                                ...
                                <Card.Body>
                                    <p className="text-muted">Use <code>btn-subtle-</code>  class with the below-mentioned variation to create a button with the soft background.</p>                                        <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <button className="btn btn-soft-primary material-shadow-none waves-effect waves-light"> Primary </button>
                                            <button className="btn btn-soft-secondary material-shadow-none waves-effect waves-light"> Secondary </button>
                                            <button className="btn btn-soft-success material-shadow-none waves-effect waves-light"> Success </button>
                                            <button className="btn btn-soft-info material-shadow-none waves-effect waves-light"> Info </button>
                                            <button className="btn btn-soft-warning material-shadow-none waves-effect waves-light"> Warning </button>
                                            <button className="btn btn-soft-danger material-shadow-none waves-effect waves-light"> Danger </button>
                                            <button className="btn btn-soft-dark material-shadow-none waves-effect waves-light"> Dark </button>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ height: "275px" }}>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap align-items-center gap-2">
                                            <ButtonGroup aria-label="Basic checkbox toggle button group">
                                                ...
                                                <Button as='label' variant='primary' className="mb-0 material-shadow-none" htmlFor="btncheck1">Checkbox 1</Button>

                                                <input type="checkbox" className="btn-check" id="btncheck2" defaultValue='' />
                                                <Button as='label' variant='primary' className="mb-0 material-shadow-none" htmlFor="btncheck2">Checkbox 2</Button>

                                                <input type="checkbox" className="btn-check" id="btncheck3" defaultValue='' />

                                                <Button as='label' variant='primary' className="mb-0 material-shadow-none" htmlFor="btncheck3">Checkbox 3</Button>
                                            </ButtonGroup>
                                            ...
                                            <ButtonGroup aria-label="Basic radio toggle button group">
                                                ...
                                                <Button as='label' variant='outline-secondary' className="mb-0 material-shadow-none" htmlFor="btnradio1">Radio 1</Button>

                                                <input type="radio" className="btn-check" name="btnradio" id="btnradio2" defaultValue='' />
                                                <Button as='label' variant='outline-secondary' className="mb-0 material-shadow-none" htmlFor="btnradio2">Radio 2</Button>

                                                <input type="radio" className="btn-check" name="btnradio" id="btnradio3" defaultValue='' />

                                                <Button as='label' variant='outline-secondary' className="mb-0 material-shadow-none" htmlFor="btnradio3">Radio 3</Button>
                                            </ButtonGroup>
                                        </div>
                                    </div>
                                    <div className="d-none code-view" >
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col sm={6}>
                                                <ButtonGroup>
                                                    <Button className='material-shadow-none' variant="primary"> Left </Button>
                                                    <Button className='material-shadow-none' variant="primary"> Middle </Button>
                                                    <Button className='material-shadow-none' variant="primary"> Right </Button>
                                                </ButtonGroup>
                                            </Col>
                                            <Col sm={6}>
                                        ...
                                        <Row>
                                            ...
                                            <Col sm={6}>
                                                <div className="hstack gap-2 mt-4 mt-sm-0">
                                                    <Button variant="outline-primary" className="btn-icon material-shadow-none"> <i className="ri-24-hours-fill" /> </Button>
                                                    <Button variant="outline-danger" className="btn-icon material-shadow-none"> <i className="ri-customer-service-2-line" /> </Button>
                                                    <Button variant="outline-success" className="btn-icon material-shadow-none"> <i className="ri-mail-send-line" /> </Button>
                                                    <Button variant="outline-warning" className="btn-icon material-shadow-none"> <i className="ri-menu-2-line" /> </Button>
                                                </div>
                                            </Col>
                                        </Row>
                                    </div>
                                        ...
                                        <div className="d-flex flex-wrap gap-3">
                                            <ButtonToolbar>
                                                <ButtonGroup className="me-2">
                                                    <Button className='material-shadow-none' variant="light">1</Button>
                                                    <Button className='material-shadow-none' variant="light">2</Button>
                                                    <Button className='material-shadow-none' variant="light">3</Button>
                                                    <Button className='material-shadow-none' variant="light">4</Button>
                                                </ButtonGroup>
                                                <ButtonGroup className="me-2">
                                                    <Button className='material-shadow-none' variant="light">5</Button>
                                                    <Button className='material-shadow-none' variant="light">6</Button>
                                                    <Button className='material-shadow-none' variant="light">7</Button>

                                                </ButtonGroup>
                                                <ButtonGroup>
                                                    <Button className='material-shadow-none' variant="light">8</Button>
                                                </ButtonGroup>
                                            </ButtonToolbar>
                                        </div>
                                    </div>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap align-items-center gap-2">
                                            ...
                                            <ButtonGroup className="mt-2">
                                                <Button className='material-shadow-none' variant="light">Left</Button>
                                                <Button className='material-shadow-none' variant="light">Middle</Button>
                                                <Button className='material-shadow-none' variant="light">Right</Button>
                                            </ButtonGroup>
                                            <ButtonGroup size="sm" className="mt-2">
                                                <Button className='material-shadow-none' variant="secondary">Left</Button>
                                                <Button className='material-shadow-none' variant="secondary">Middle</Button>
                                                <Button className='material-shadow-none' variant="secondary">Right</Button>
                                            </ButtonGroup>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <div className="col-auto">
                                                <ButtonGroup className='material-shadow' aria-label="Button group with nested dropdown">
                                            ...
                                            <div className="col-auto">
                                                <ButtonGroup className='material-shadow' vertical role="group" aria-label="Vertical button group">
                                            ...
                                            <div className="col-auto">
                                                <ButtonGroup vertical aria-label="Vertical radio toggle button group" className='material-shadow'>
                                                    <input type="radio" className="btn-check" name="vbtn" id="vbtn-radio1" defaultChecked defaultValue='' />
                                                    <Button as='label' className='material-shadow-none' variant="outline-secondary" htmlFor="vbtn-radio1">Radio 1</Button>
                                                    <input type="radio" className="btn-check" name="vbtn" id="vbtn-radio2" defaultValue='' />
                                                    <Button as='label' className='material-shadow-none' variant="outline-secondary" htmlFor="vbtn-radio2">Radio 2</Button>
                                                    <input type="radio" className="btn-check" name="vbtn" id="vbtn-radio3" defaultValue='' />
                                                    <Button as='label' className='material-shadow-none' variant="outline-secondary" htmlFor="vbtn-radio3">Radio 3</Button>
                                                </ButtonGroup>
                                            </div>
                                        </Row>
                                    </div>

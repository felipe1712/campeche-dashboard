                                    ...
                                    <div className="live-preview">
                                        ...
                                        <div className="mt-5">
                                            ...
                                            <div className="vstack gap-2 col-md-5 mx-auto">
                                                <Button variant="primary" className='material-shadow'>Save changes</Button>
                                                <Button variant="outline-secondary" className='material-shadow'>Cancel</Button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <div className="mt-5">
                                            ...
                                            <div className="hstack gap-3">
                                                ...
                                                <div className="vr"></div>
                                                <Button variant="outline-secondary" className='material-shadow-none'>Reset</Button>
                                            </div>
                                        </div>
                                    </div>

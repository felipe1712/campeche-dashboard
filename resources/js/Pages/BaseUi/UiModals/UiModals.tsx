    ...
    return (
        <React.Fragment>
            ...
            >
                ...
                <Modal.Body className="text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-muted mb-4"> The transfer was not successfully received by us. the email of the recipient wasn't correct.</p>
                        <div className="hstack gap-2 justify-content-center">
                            <Link href="#" className="btn btn-link link-success fw-medium material-shadow-none" onClick={tog_backdrop}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
            ...
            <Modal show={modal_tooltip} onHide={tog_tooltip}>
                ...
                <Modal.Body>
                    ...
                    <p className="text-muted">Opposites attract, and that’s a fact. It’s in our <OverlayTrigger placement='top' overlay={<Tooltip id="tooltip-top"> graphic design </Tooltip>}>
                        <Link href="#" className="tooltip-test text-decoration-underline fw-medium material-shadow-none" id="UncontrolledTooltip1">
                            graphic design
                        </Link>
            ...
            <Modal id="exampleModalFullscreenSm" show={modal_fullscreen_sm} onHide={() => { tog_fullscreen_sm(); }} >
                ...
                <Modal.Footer>
                    <Link href="#" className="btn btn-link link-success fw-medium material-shadow-none" onClick={() => { tog_fullscreen_sm(); }}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                    <Button variant="primary"> Save changes </Button>
                </Modal.Footer>
            </Modal>
            ...
            <Modal id="exampleModalFullscreenMd" show={modal_fullscreen_md} onHide={() => { tog_fullscreen_md(); }} >
                ...
                <Modal.Footer>
                    <Link href="#" className="btn btn-link link-success fw-medium material-shadow-none" onClick={() => { tog_fullscreen_md(); }}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                    <Button variant="primary" > Save changes </Button>
                </Modal.Footer>
            </Modal>
            ...
            <Modal id="exampleModalFullscreenLg" show={modal_fullscreen_lg} onHide={() => { tog_fullscreen_lg(); }} >
                ...
                <Modal.Footer>
                    <Link href="#" className="btn btn-link link-success fw-medium material-shadow-none" onClick={() => { tog_fullscreen_lg(); }}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                    <Button variant="primary" > Save changes </Button>
                </Modal.Footer>
            </Modal>
            ...
            <Modal id="exampleModalFullscreenXl" show={modal_fullscreen_xl} onHide={() => { tog_fullscreen_xl(); }} >
                ...
                <Modal.Footer>
                    <Link href="#" className="btn btn-link link-success fw-medium material-shadow-none" onClick={() => { tog_fullscreen_xl(); }}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                    <Button variant="primary" > Save changes </Button>
                </Modal.Footer>
            </Modal>
            ...
            <Modal id="exampleModalFullscreenXxl" show={modal_fullscreen_xxl} onHide={() => { tog_fullscreen_xxl(); }} >
                ...
                <Modal.Footer>
                    <Link href="#" className="btn btn-link link-success fw-medium material-shadow-none" onClick={() => { tog_fullscreen_xxl(); }}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                    <Button variant="primary" > Save changes </Button>
                </Modal.Footer>
            </Modal>
            ...
            <Modal id="top-rightmodal" show={modal_positionTopRight} onHide={() => { tog_positionTopRight(); }} dialogClassName="modal-dialog-right" >
                ...
                <Modal.Body className="text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-muted mb-4"> The transfer was not successfully received by us. the email of the recipient wasn't correct.</p>
                        <div className="hstack gap-2 justify-content-center">
                            <Link href="#" className="btn btn-link link-success fw-medium material-shadow-none" onClick={() => { tog_positionTopRight(); }}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                            <Link href="#" className="btn btn-success">Completed</Link>
                        </div>
                    </div>
                </Modal.Body>
            ...
            <Modal id="bottomModal" show={modal_positionBottom} onHide={() => { tog_positionBottom(); }} dialogClassName="modal-dialog-bottom" >
                ...
                <Modal.Body className="text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-muted mb-4">The transfer was not successfully received by us. the email of the recipient wasn't correct.</p>
                        <div className="hstack gap-2 justify-content-center">
                            <Link href="#" className="btn btn-link link-success fw-medium material-shadow-none" onClick={() => setmodal_positionBottom(false)}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                            <Link href="#" className="btn btn-success">Completed</Link>
                        </div>
                    </div>
                </Modal.Body>
            ...
            <Modal id="bottom-rightModal" show={modal_positionBottomRight} onHide={() => { tog_positionBottomRight(); }} dialogClassName="modal-dialog-bottom-right" >
                ...
                <Modal.Body className="text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-muted mb-4"> The transfer was not successfully received by us. the email of the recipient wasn't correct.</p>
                        <div className="hstack gap-2 justify-content-center">
                            <Link href="#" className="btn btn-link link-success fw-medium material-shadow-none" onClick={() => setmodal_positionBottomRight(false)}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
                            <Link href="#" className="btn btn-success">Completed</Link>
                        </div>
                    </div>
                </Modal.Body>

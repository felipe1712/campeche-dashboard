                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        <Accordion id="default-accordion-example" defaultActiveKey="1">
                                            <Accordion.Item className='material-shadow' eventKey='1'>
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='2'>
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='3'>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion id="default-accordion-example" defaultActiveKey="4">
                                            <Accordion.Item className='material-shadow' eventKey='4'>
                                                <Accordion.Header>
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='5'>
                                                <Accordion.Header >
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='6'>
                                                <Accordion.Header >
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon accordion-secondary" defaultActiveKey="7">
                                            <Accordion.Item className='material-shadow' eventKey='7'>
                                                <Accordion.Header id="headingOne">
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='8'>
                                                <Accordion.Header id="headingTwo">
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='9'>
                                                <Accordion.Header id="headingThree">
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="accordion-icon-none" defaultActiveKey="10">
                                            <Accordion.Item className='material-shadow' eventKey='10'>
                                                <Accordion.Header>
                                                    <i className="ri-global-line me-2"></i> How Does Age Verification Work?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='11'>
                                                <Accordion.Header>
                                                    <i className="ri-user-location-line me-2"></i> How Does Link Tracking Work?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='12'>
                                                <Accordion.Header>
                                                    <i className="ri-pen-nib-line me-2"></i> How Do I Set Up the Drip Feature?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon-plus" id="accordionWithplusicon" defaultActiveKey="14">
                                            <Accordion.Item className='material-shadow' eventKey='14'>
                                                <Accordion.Header>
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='15'>
                                                <Accordion.Header>
                                                    Where does it come from ?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        <Accordion className="lefticon-accordion custom-accordionwithicon accordion-border-box" id="accordionlefticon" defaultActiveKey='16'>
                                            <Accordion.Item className='material-shadow' eventKey='16'>
                                                <Accordion.Header>
                                                    What is User Interface Design?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='17'>
                                                <Accordion.Header>
                                                    What is Digital Marketing?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='18'>
                                                <Accordion.Header>
                                                    Where does it come from ?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon custom-accordion-border accordion-border-box accordion-success" id="accordionBordered" defaultActiveKey="19">
                                            <Accordion.Item className='material-shadow' eventKey='19'>
                                                <Accordion.Header>
                                                    What is User Interface Design?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='20'>
                                                <Accordion.Header>
                                                    What is Digital Marketing?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='21'>
                                                <Accordion.Header>
                                                    Where does it come from ?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon accordion-border-box" id="accordionnesting" defaultActiveKey="22">
                                            <Accordion.Item className='material-shadow' eventKey='22'>
                                                <Accordion.Header>
                                                ...
                                                <Accordion.Body>
                                                    ...
                                                    <Accordion defaultActiveKey="23" className="nesting2-accordion custom-accordionwithicon accordion-border-box mt-3" id="accordionnesting2">
                                                        <Accordion.Item className='material-shadow' eventKey='23'>
                                                            <Accordion.Header>
                                                            ...
                                                            <Accordion.Body>
                                                                ...
                                                                <Accordion defaultActiveKey="24" className="nesting4-accordion custom-accordionwithicon accordion-border-box mt-3" id="accordionnesting4">
                                                                    <Accordion.Item className='material-shadow' eventKey='24'>
                                                        ...
                                                        <Accordion.Item className='material-shadow' eventKey='25'>
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='26'>
                                                <Accordion.Header>
                                                ...
                                                <Accordion.Body>
                                                    ...
                                                    <Accordion defaultActiveKey="27" className="nesting3-accordion custom-accordionwithicon accordion-border-box mt-3" id="accordionnesting3">
                                                        <Accordion.Item className='material-shadow mt-2' eventKey='27'>
                                                            <Accordion.Header id="accordionnesting4Example2">
                                            ...
                                            <Accordion.Item className='material-shadow' eventKey='28'>
                                                <Accordion.Header>
                                        ...
                                        <Row>
                                            <Col xxl={6}>
                                                <Accordion className="custom-accordionwithicon accordion-fill-success" id="accordionFill" defaultActiveKey="29">
                                                    <Accordion.Item className='material-shadow' eventKey='29'>
                                                        <Accordion.Header>
                                                            What are webhooks?
                                                        </Accordion.Header>
                                                        <Accordion.Body>
                                                    ...
                                                    <Accordion.Item className='material-shadow' eventKey='30'>
                                                        <Accordion.Header>
                                                    ...
                                                    <Accordion.Item className='material-shadow' eventKey='31'>
                                                        <Accordion.Header>
                                            ...
                                            <Col xxl={6}>
                                                ...
                                                <Accordion className="custom-accordionwithicon accordion-flush accordion-fill-secondary" id="accordionFill2" defaultActiveKey="32">
                                                    <Accordion.Item className='material-shadow' eventKey='32'>
                                                        <Accordion.Header>
                                                    ...
                                                    <Accordion.Item className='material-shadow' eventKey='33'>
                                                        <Accordion.Header>
                                                    ...
                                                    <Accordion.Item className='material-shadow' eventKey='34'>
                                                        <Accordion.Header>
                                                            How Do I Delete a Contact From My List?
                                                        </Accordion.Header>
                                                        <Accordion.Body>

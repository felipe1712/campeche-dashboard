                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                <h6>Primary Alert</h6>
                                                <Alert variant="primary" className='material-shadow border-0'>
                                                    <strong> Hi! </strong> A simple <b>Primary alert</b> —check it out!
                                                </Alert>

                                                <h6>Secondary Alert</h6>
                                                <Alert variant="secondary" className='material-shadow border-0'>
                                                    <strong> How are you! </strong> A simple <b>secondary alert</b> —check it out!
                                                </Alert>

                                                <h6>Success Alert</h6>
                                                <Alert variant="success" className='material-shadow border-0'>
                                                    <strong> Yey! Everything worked! </strong> A simple <b>success alert</b> —check it out!
                                                </Alert>

                                                <h6>Danger Alert</h6>
                                                <Alert variant="danger" className='material-shadow border-0 mb-xl-0'>
                                            ...
                                            <Col xl={6}>
                                                <h6>Warning Alert</h6>
                                                <Alert variant="warning" className='material-shadow border-0'>
                                                    <strong> Uh oh, something went wrong </strong> A simple <b>warning alert</b> —check it out!
                                                </Alert>

                                                <h6>Info Alert</h6>
                                                <Alert variant="info" className='material-shadow border-0'>
                                                    <strong>Don't forget' it !</strong> A simple <b>info alert</b> —check it out!
                                                </Alert>

                                                <h6>Light Alert</h6>
                                                <Alert variant="light" className='material-shadow border-0 bg-light'>
                                                    <strong>Mind Your Step!</strong> A simple <b>light alert</b> —check it out!
                                                </Alert>

                                                <h6>Dark Alert</h6>
                                                <Alert variant="dark" className='material-shadow border-0 mb-0'>
                                                    <strong>Did you know?</strong> A simple <b>dark alert</b> —check it out!
                                                </Alert>
                                            ...
                                            <Col xl={6}>
                                                {(alert || []).slice(0, 4).map((value: AlertProps, inx: number) => (
                                                    <React.Fragment key={inx}>
                                                        ...
                                                        <Alert className='material-shadow' key={inx} variant={value.variant} role="alert" dismissible>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <h6>Danger Alert</h6>
                                                <Alert className='material-shadow mb-xl-0' variant="danger">
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            ...
                                            <Alert variant="primary" className="material-shadow bg-body-secondary" role="alert" dismissible>
                                                <strong> Hi! </strong> - Outline <b>primary alert</b> example
                                            </Alert>

                                            <h6>Secondary Outline Alert</h6>
                                            <Alert variant="secondary"  className="material-shadow bg-body-secondary" role="alert" dismissible>
                                                <strong> How are you! </strong> - Outline <b>secondary alert</b> example
                                            </Alert>

                                            <h6>Success Outline Alert</h6>
                                            <Alert variant="success" className="material-shadow bg-body-secondary" role="alert" dismissible>
                                                <strong> Yey! Everything worked! </strong> - Outline <b>success alert</b> example
                                            </Alert>

                                            <h6>Danger Outline Alert</h6>
                                            <Alert variant="danger" className="material-shadow bg-body-secondary mb-xl-0" role="alert" dismissible>
                                            ...
                                            <Alert variant="warning" className="material-shadow bg-body-secondary" role="alert" dismissible>
                                                <strong> Uh oh, something went wrong! </strong> - Outline <b>warning alert</b> example
                                            </Alert>

                                            <h6>Info Outline Alert</h6>
                                            <Alert variant="info" className="material-shadow bg-body-secondary" role="alert" dismissible>
                                                <strong>Don't forget' it !</strong> - Outline <b>info alert</b> example
                                            </Alert>

                                            <h6>Dark Alert</h6>
                                            <Alert variant="dark" className="material-shadow text-body bg-body-secondary mb-0" role="alert" dismissible>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                            <h6>Primary Alert</h6>
                                            <Alert variant="primary" className="material-shadow alert-border-left" role="alert" dismissible>
                                                <i className="ri-user-smile-line me-3 align-middle fs-lg"></i>
                                                <strong> Primary </strong>- Left border alert
                                            </Alert>

                                            <h6>Secondary Alert</h6>
                                            <Alert variant="secondary" className="material-shadow alert-border-left" role="alert" dismissible>
                                                <i className="ri-check-double-line me-3 align-middle fs-lg"></i><strong>Secondary</strong> - Left border alert
                                            </Alert>

                                            <h6>Success Alert</h6>
                                            <Alert variant="success" className="material-shadow alert-border-left" role="alert" dismissible>
                                                <i className="ri-notification-off-line me-3 align-middle fs-lg"></i><strong>Success</strong> - Left border alert
                                            </Alert>

                                            <h6>Danger Alert</h6>
                                            <Alert variant="danger" className="material-shadow alert-border-left mb-xl-0" role="alert" dismissible>
                                            ...
                                            <Col xl={6}>
                                            <h6>Warning Alert</h6>
                                            <Alert variant="warning" className="material-shadow alert-border-left" role="alert" dismissible>
                                                <i className="ri-alert-line me-3 align-middle fs-lg"></i><strong>Warning</strong> - Left border alert
                                            </Alert>

                                            <h6>Info Alert</h6>
                                            <Alert variant="info" className="material-shadow alert-border-left" role="alert" dismissible>
                                                <i className="ri-airplay-line me-3 align-middle fs-lg"></i><strong>Info</strong> - Left border alert
                                            </Alert>

                                            <h6>Light Alert</h6>
                                            <Alert variant="light" className="material-shadow alert-border-left" role="alert" dismissible>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                            <h6>Primary Alert</h6>
                                            <Alert variant="primary" className="material-shadow text-white bg-primary alert-label-icon" role="alert" closeVariant="white" dismissible>
                                                <i className="ri-user-smile-line label-icon"></i><strong>Primary</strong> - Label icon alert
                                            </Alert>

                                            <h6>Secondary Alert</h6>
                                            <Alert variant="secondary" className="material-shadow text-white bg-secondary alert-label-icon" role="alert" closeVariant="white" dismissible>
                                                <i className="ri-check-double-line label-icon"></i><strong>Secondary</strong> - Label icon alert
                                            </Alert>

                                            <h6>Success Alert</h6>
                                            <Alert variant="success" className="material-shadow text-white bg-success alert-label-icon" role="alert" closeVariant="white" dismissible>
                                                <i className="ri-notification-off-line label-icon"></i><strong>Success</strong> - Label icon alert
                                            </Alert>

                                            <h6>Danger Alert</h6>
                                            <Alert variant="danger" className="material-shadow text-white bg-danger alert-label-icon mb-xl-0" role="alert" closeVariant="white" dismissible>
                                            ...
                                            <Col xl={6}>
                                            <h6>Warning Alert</h6>
                                            <Alert variant="warning" className="material-shadow text-white bg-warning alert-label-icon" role="alert" closeVariant="white" dismissible>
                                                <i className="ri-alert-line label-icon"></i><strong>Warning</strong> - Label icon alert
                                            </Alert>

                                            <h6>Info Alert</h6>
                                            <Alert variant="info" className="material-shadow text-white bg-info alert-label-icon" role="alert" closeVariant="white" dismissible>
                                                <i className="ri-airplay-line label-icon"></i><strong>Info</strong> - Label icon alert
                                            </Alert>

                                            <h6>Light Alert</h6>
                                            <Alert variant="light" className="material-shadow text-body bg-light alert-label-icon" role="alert" closeVariant="white" dismissible>
                                                <i className="ri-mail-line label-icon"></i><strong>Light</strong> - Label icon alert
                                            </Alert>

                                            <h6>Dark Alert</h6>
                                            <Alert variant="dark" className="material-shadow text-white bg-dark alert-label-icon mb-0" role="alert" closeVariant="white" dismissible>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <Alert variant="primary" className="alert-additional material-shadow" role="alert" dismissible>
                                                ...
                                                <h6>Danger Alert</h6>
                                                <Alert variant="danger" className="alert-additional material-shadow mb-xl-0" role="alert" dismissible>
                                                <div className="alert-body">
                                                    <div className="d-flex">
                                                        <div className="flex-shrink-0 me-3">
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <h6>Success Alert</h6>
                                                <Alert variant="success" role="alert" className="alert-additional material-shadow" dismissible>
                                                <div className="alert-body">
                                                    <div className="d-flex">
                                                        <div className="flex-shrink-0 me-3">
                                                ...
                                                <h6>Warning Alert</h6>
                                                <Alert variant="warning" className="alert-additional material-shadow mb-0" role="alert" dismissible>
                                                <div className="alert-body">
                                                    <div className="d-flex">
                                                        <div className="flex-shrink-0 me-3">
                                                            <i className="ri-alert-line fs-lg align-middle"></i>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                            <h6>Primary Alert</h6>
                                            <Alert variant="primary" className="alert-top-border material-shadow" role="alert" dismissible>
                                                <i className="me-3 align-middle fs-lg text-primary ri-user-smile-line label-icon"></i><strong>Primary</strong> - Top border alert
                                            </Alert>

                                            <h6>Secondary Alert</h6>
                                            <Alert variant="secondary" className="alert-top-border material-shadow" role="alert" dismissible>
                                            ...
                                            <h6>Success Alert</h6>
                                            <Alert variant="success" className="alert-top-border material-shadow" role="alert" dismissible>
                                            ...
                                            <h6>Danger Alert</h6>
                                            <Alert variant="danger" className="alert-top-border material-shadow mb-xl-0" role="alert" dismissible>
                                            ...
                                            <Col xl={6}>
                                            <h6>Warning Alert</h6>
                                            <Alert variant="warning" className="alert-top-border material-shadow" role="alert" dismissible>
                                                <i className="me-3 align-middle fs-lg text-warning ri-alert-line label-icon"></i><strong>Warning</strong> - Top border alert
                                            </Alert>

                                            <h6>Info Alert</h6>
                                            <Alert variant="info" className="alert-top-border material-shadow" role="alert" dismissible>
                                                <i className="me-3 align-middle fs-lg text-info ri-airplay-line label-icon"></i><strong>Info</strong> - Top border alert
                                            </Alert>

                                            <h6>Light Alert</h6>
                                            <Alert variant="light" className="alert-top-border material-shadow" role="alert" dismissible>
                                                <i className="ri-mail-line me-3 align-middle fs-lg text-dark"></i><strong>Light</strong> - Top border alert
                                            </Alert>

                                            <h6>Dark Alert</h6>
                                            <Alert variant="dark" className="alert-top-border material-shadow mb-0" role="alert" dismissible>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Row>
                                            <Col xl={6}>
                                            <h6>Primary Alert</h6>
                                            <Alert variant="primary" className="alert-label-icon material-shadow label-arrow" dismissible role="alert">
                                                <i className="ri-user-smile-line label-icon"></i><strong>Primary</strong> - Label icon arrow alert
                                            </Alert>

                                            <h6>Secondary Alert</h6>
                                            <Alert variant="secondary" className="alert-label-icon material-shadow label-arrow" role="alert" dismissible>
                                                <i className="ri-check-double-line label-icon"></i><strong>Secondary</strong> - Label icon arrow alert
                                            </Alert>

                                            <h6>Success Alert</h6>
                                            <Alert variant="success" className="alert-label-icon material-shadow label-arrow" role="alert" dismissible>
                                                <i className="ri-notification-off-line label-icon"></i><strong>Success</strong> - Label icon arrow alert
                                            </Alert>

                                            <h6>Danger Alert</h6>
                                            <Alert variant="danger" className="alert-label-icon material-shadow label-arrow mb-xl-0" role="alert" dismissible>
                                            ...
                                            <h6>Warning Alert</h6>
                                            <Alert variant="warning" className="alert-label-icon material-shadow label-arrow" role="alert" dismissible>
                                                <i className="ri-alert-line label-icon"></i><strong>Warning</strong> - Label icon arrow alert
                                            </Alert>

                                            <h6>Info Alert</h6>
                                            <Alert variant="info" className="alert-label-icon material-shadow label-arrow" role="alert" dismissible>
                                                <i className="ri-airplay-line label-icon"></i><strong>Info</strong> - Label icon arrow alert
                                            </Alert>

                                            <h6>Light Alert</h6>
                                            <Alert variant="light" className="alert-label-icon material-shadow label-arrow" role="alert" dismissible>
                                                <i className="ri-mail-line label-icon"></i><strong>Light</strong> - Label icon arrow alert
                                            </Alert>

                                            <h6>Dark Alert</h6>
                                            <Alert variant="dark" className="alert-label-icon material-shadow label-arrow mb-0" role="alert" dismissible>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Row>
                                            <Col xl={6}>
                                            <h6>Primary Alert</h6>
                                            <Alert variant="primary" className="alert-label-icon material-shadow rounded-label" role="alert" dismissible>
                                                <i className="ri-user-smile-line label-icon"></i><strong>Primary</strong> - Rounded label alert
                                            </Alert>

                                            <h6>Secondary Alert</h6>
                                            <Alert variant="secondary" className="alert-label-icon material-shadow rounded-label" role="alert" dismissible>
                                                <i className="ri-check-double-line label-icon"></i><strong>Secondary</strong>- Rounded label alert
                                            </Alert>

                                            <h6>Success Alert</h6>
                                            <Alert variant="success" className="alert-label-icon material-shadow  -label" role="alert" dismissible>
                                                <i className="ri-notification-off-line label-icon"></i><strong>Success</strong>- Rounded label alert
                                            </Alert>

                                            <h6>Danger Alert</h6>
                                            <Alert variant="danger" className="alert-label-icon material-shadow rounded-label mb-xl-0" role="alert" dismissible>
                                            ...
                                            <Col xl={6}>
                                            <h6>Warning Alert</h6>
                                            <Alert variant="warning" className="alert-label-icon material-shadow rounded-label" role="alert" dismissible>
                                                <i className="ri-alert-line label-icon"></i><strong>Warning</strong> - Rounded label alert
                                            </Alert>

                                            <h6>Info Alert</h6>
                                            <Alert variant="info" className="alert-label-icon material-shadow rounded-label" role="alert" dismissible>
                                                <i className="ri-airplay-line label-icon"></i><strong>Info</strong> - Rounded label alert
                                            </Alert>

                                            <h6>Light Alert</h6>
                                            <Alert variant="light" className="alert-label-icon material-shadow rounded-label" role="alert" dismissible>
                                                <i className="ri-mail-line label-icon"></i><strong>Light</strong> - Rounded label alert
                                            </Alert>

                                            <h6>Dark Alert</h6>
                                            <Alert variant="dark" className="alert-label-icon material-shadow rounded-label mb-0" role="alert" dismissible>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <Alert variant="primary" className="material-shadow bg-primary text-white border-0">
                                                    <strong>Hi!</strong> - Solid <b>primary alert</b> example
                                                </Alert>

                                                <h6>Secondary Solid Alert</h6>
                                                <Alert variant="secondary" className="material-shadow border-0 bg-secondary text-white">
                                                    <strong>How are you!</strong> - Solid <b>secondary alert</b> example
                                                </Alert>

                                                <h6>Success Solid Alert</h6>
                                                <Alert variant="success" className="material-shadow border-0 bg-success text-white">
                                                    <strong>Yey! Everything worked! </strong> - Solid <b>success alert</b> example
                                                </Alert>

                                                <h6>Danger Solid Alert</h6>
                                                <Alert variant="danger" className="material-shadow border-0 bg-danger text-white mb-xl-0">
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <Alert variant="warning" className="material-shadow border-0 bg-warning text-white">
                                                    <strong>Uh oh, something went wrong!</strong> - Solid <b>warning alert</b> example
                                                </Alert>

                                                <h6>Info Solid Alert</h6>
                                                <Alert variant="info" className="material-shadow border-0 bg-info text-white">
                                                    <strong>Don't forget' it !</strong> - Solid <b>info alert</b> example
                                                </Alert>

                                                <h6>Light Solid Alert</h6>
                                                <Alert variant="light" className="material-shadow border-0 bg-light text-white">
                                                    <strong>Mind Your Step!</strong> - Solid <b>secondary alert</b> example
                                                </Alert>

                                                <h6>Dark Solid Alert</h6>
                                                <Alert variant="dark" className="material-shadow border-0 bg-dark text-white mb-0">

...
import { Card, CardBody, Col, Container, Modal, Row, Dropdown, Form, Button } from 'react-bootstrap';
                                                ...
                                                <Card className="bg-light shadow-none" id={"folder-" + item.id}>
                                                    <CardBody>
                                                        <div className="d-flex mb-1">
                                                            ...
                                                            <Dropdown>
                                                                <Dropdown.Toggle as="button" className="arrow-none btn btn-ghost-primary btn-icon btn-sm dropdown material-shadow-none">
                                                    ...
                                                    <tr key={key}>
                                                        ...
                                                        <td>
                                                            <div className="d-flex gap-3 justify-content-center">
                                                                ...
                                                                <Dropdown dir='start'>
                                                                    <Dropdown.Toggle as="button" className="arrow-none btn btn-light btn-icon btn-sm dropdown material-shadow-none" id="dropdown.MenuButton">

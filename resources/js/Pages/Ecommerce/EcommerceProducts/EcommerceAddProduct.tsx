...
import { Card, Col, Container, Nav, Row, Form, Tab } from "react-bootstrap";
                            ...
                            <Col lg={6}>
                              <div className="mb-3">
                                ...
                                <Form.Control
                                  ...
                                  value={
                                    validation.values.manufacturer_name || ""
                                  }
                                  onBlur={validation.handleBlur}
                                  onChange={validation.handleChange}
                                />
                            ...
                            <Col lg={6}>
                              <div className="mb-3">
                                ...
                                <Form.Control
                                  ...
                                  value={
                                    validation.values.manufacturer_brand || ""
                                  }
                                  onBlur={validation.handleBlur}
                                  onChange={validation.handleChange}
                                />
                              ...
                              <div className="mb-3">
                                ...
                                <div className="input-group mb-3">
                                  ...
                                  <Form.Control
                                    ...
                                    value={
                                      validation.values.product_discount || ""
                                    }
                                    onBlur={validation.handleBlur}
                                    onChange={validation.handleChange}
                                  />

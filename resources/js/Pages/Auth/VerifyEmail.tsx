                                    ...
                                    <Card className="mt-4">
                                        <Card.Body className="p-4">
                                            ...
                                            <div className="p-2 mt-4">
                                                ...
                                                <div className="mt-3">
                                                    <Button variant="success" className="w-100" type="submit">Confirm</Button>
                                                </div>
                                            </div>
                                        </Card.Body>
                                    </Card>
                                    <div className="mt-4 text-center">
                                        <p className="mb-0">Didn't receive a code ? <Link href={route('password.reset')} className="fw-semibold text-primary text-decoration-underline">Resend</Link> </p>
                                    </div>
                                </Col>
                            </Row>
                        </Container>

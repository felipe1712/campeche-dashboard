                  ...
                  <div className="flex-shrink-0">
                    ...
                    >
                      <Button
                        ...
                        variant="success"
                        size="sm"
                        className="shadow-none btn-soft-success material-shadow-none"
                      >
                          ...
                          <div className="flex-shrink-0">
                            ...
                            >
                              <Button
                                ...
                                variant="success"
                                size="sm"
                                className="btn-soft-success material-shadow"
                              >
                                <i className="ri-add-line align-bottom"></i>
                              </Button>
                            </OverlayTrigger>
                        ...
                        <div className="d-flex align-items-center px-4 mt-4 pt-2 mb-2">
                          ...
                          <div className="flex-shrink-0">
                            <OverlayTrigger
                              placement="bottom"
                              overlay={
                                <Tooltip id="tooltip">Create group</Tooltip>
                              }
                              rootClose={true}
                            >
                              <Button
                        ...
                        <Col sm={8} xs={4}>
                          <ul className="list-inline user-chat-nav text-end mb-0">
                            ...
                            <li className="list-inline-item m-0">
                              ...
                              >
                                <Dropdown.Toggle
                                  className="btn btn-ghost-secondary btn-icon arrow-none material-shadow-none"
                                  as="button"
                                >
                                  <FeatherIcon
                                    icon="more-vertical"

                                ...
                                {marketPlacewidget.map((item, key) => (<Col lg={4} md={6} key={key}>
                                    <Card>
                                        <Card.Body>
                                            ...
                                            <h5 className="mb-0 fs-16"><Link href="#">{item.category} <span className="badge bg-success-subtle text-success">{item.quantity}</span></Link></h5>
                                        </Card.Body>
                                    </Card>
                                </Col>))}
                            </Row>
                            ...
                            <Card className="bg-primary" style={{ backgroundImage: `url(${BgPattern})` }}>
                                <Card.Body className="p-4">
                                    ...
                                    <div className="hstack gap-2">
                                        <Link href="/apps-nft-create" className="btn btn-success">Create NFT</Link>
                                        <Link href="/apps-nft-explore" className="btn btn-danger">Explore Now</Link>
                                    </div>
                                </Card.Body>
                            </Card>
                        </Col>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card className="overflow-hidden shadow-none material-shadow">
                                <Card.Body className="bg-success-subtle text-success fw-semibold d-flex">
                                    <div>
                                        <div>
                        ...
                        <Col lg={12}>
                            <div className="d-lg-flex align-items-center mb-4">
                                ...
                                <div className="flex-shrink-0 mt-4 mt-lg-0">
                                    <Link href="/apps-nft-explore" className="btn btn-soft-primary">View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                </div>
                            </div>
                        </Col>
                    </Row>
                                ...
                                <Card className="explore-box">
                                    <Card.Body>
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <h6 className="fs-16 mb-0"><Link href="/apps-nft-item-details">{item.category}</Link></h6>
                                        </div>
                                    </Card.Body>
                                </Card>
                            </Col>
                    ...
                    <Row>
                        <Col lg={12}>
                            <div className="d-lg-flex align-items-center mb-4">
                                ...
                                <div className="flex-shrink-0 mt-4 mt-lg-0">
                                    <Link href="/apps-nft-creators" className="btn btn-soft-primary">View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                </div>
                            </div>
                        </Col>
                    </Row>
                        ...
                        {nftArtworkData.map((item, key) => (
                            <Col key={key}>
                                <Card className="explore-box card-animate">
                                    ...
                                    <Card.Body>
                                        <p className="fw-medium mb-0 float-end"><i className="mdi mdi-heart text-danger align-middle"></i> {item.likes} </p>
                                        <h5 className="mb-1"><Link href="/apps-nft-item-details">{item.title}</Link></h5>
                            ...
                            <Col key={key}>
                                <Card>
                                    ...
                                    <Card.Body className="text-center">
                                        ...
                                        <h5 className="mt-3 mb-1"><Link href="#">{item.author}</Link></h5>

                    ...
                    <>
                        <div className="collection">
                            <div className="d-flex align-items-center">
                                <img src={collection.row.original.img} alt="" className="avatar-xs rounded-circle object-fit-cover me-2" /> <Link href="/apps-nft-item-details" className="text-body">{collection.row.original.collection}</Link>
                            </div>
                        </div>
                    </>
                ),

                                ...
                                {(aution.filter(({ category }) => displayCategory === category || displayCategory === "All")).map((item, key) => (<Col xxl={3} lg={4} md={6} className="product-item upto-15" key={key}>
                                    <Card className="explore-box card-animate">
                                        ...
                                        <Card.Body>
                                            ...
                                            <h6 className="fs-16 mb-3"><Link href="/apps-nft-item-details">{item.title}</Link></h6>
                                            <div>
                                                ...
                                                {topDrop.map((item, key) => (<tr key={key}>
                                                    <td>
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div className="ms-2">
                                                                <Link href="/apps-nft-item-details"><h6 className="fs-15 mb-1">{item.title}</h6></Link>
                                                ...
                                                {topCreator.map((item, key) => (<tr key={key}>
                                                    <td>
                                                        <div className="d-flex align-items-center">
                                                            <img src={item.img} alt="" className="avatar-sm object-fit-cover rounded-circle" />
                                                            <div className="ms-2">
                                                                <Link href="#"><h6 className="fs-15 mb-1">{item.name}</h6></Link>

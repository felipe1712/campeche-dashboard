...
import { Col, Container, Form, Modal, Row, Dropdown, Accordion, } from 'react-bootstrap';
...
const ToDoList = () => {
    ...
    const selectTodoState = (state: any) => state.Todos;
    const todosData = createSelector(
        selectTodoState,
        (state: any) => ({
            todos: state.todos,
    ...
    const validation: any = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            subItem: Yup.string().required("Please Enter Item"),
    ...
    const dateformate = (e: any) => {
        ...
        setDate(joinDate);
        validation.setFieldValue('dueDate', joinDate)
    };
    ...
    const handleClick = (item: ImgData) => {
        ...
        setImgStore(newData);
        const subItemString = JSON.stringify(newData);


        validation.setFieldValue('subItem', subItemString)
    }
    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                <Container fluid>
                    ...
                    <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                        <div className="file-manager-sidebar minimal-border">
                            <div className="p-4 d-flex flex-column h-100">
                                <div className="mb-3">
                                    ...
                                    ><i className="ri-add-line align-bottom"></i> Add Project</button>
                                </div>
                                ...
                                <SimpleBar className="px-4 mx-n4" style={{ height: "calc(100vh - 468px)" }}>
                                    ...
                                    <ul className="to-do-menu list-unstyled" id="projectlist-data">
                                        {(projects || []).map((item: any, key: any) => (
                                            <li key={key}>
                                                <Accordion>
                                                    <Accordion.Item eventKey="0" className='arrow-none'>
                                                        <Accordion.Button className="nav-link fs-14">
                                                                {item.title}
                                                            </Accordion.Button>
                                                        <Accordion.Body>
                                                        <ul className="mb-0 sub-menu list-unstyled ps-3 vstack gap-2 mb-2">
                                                        {(item.subItem || []).map((item: any, key: any) => (<li key={key}>
                                                            <Link href="#"><i className={"ri-stop-mini-fill align-middle fs-15 text-" + item.iconClass}></i> {item.version}</Link>
                                                        </li>))}
                                                    </ul>
                                                        </Accordion.Body>
                                                    </Accordion.Item>
                        ...
                        <div className="file-manager-content minimal-border w-100 p-4 pb-0">
                            <Row className="mb-4">
                                ...
                                <div className="todo-task" id="todo-task">
                                    <div className="table-responsive">
                                        <table className="table align-middle position-relative table-nowrap">
                                            ...
                                            >
                                                {(todos || []).map((item: any, key: any) => (<tr key={key}>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div className="avatar-group">
                                                            {(item.subItem || []).map((item: any, key: any) => (<Link href="#" className="avatar-group-item" key={key}>
            ...
            <Modal id="createTask" show={modalTodo} onHide={toggle} dialogClassName="zoomIn" centered tabIndex={-1}>
                ...
                <Modal.Body>
                    ...
                    >
                        ...
                        <div className="mb-3">
                            ...
                            <Form.Control type="text" id="task-title-input" className="form-control" placeholder="Enter task title"
                                name="task"
                        ...
                        <div className="mb-3 position-relative">
                            <Form.Label htmlFor="task-assign-input" className="form-label">Assigned To</Form.Label>
                                        ...
                                        <SimpleBar style={{ maxHeight: "141px" }}>
                                            <ul className="list-unstyled mb-0">
                                                ...
                                                {(assignee || []).map((item: any, key: any) => (
                                                    <li key={key}>
                                                        <Link className="dropdown-item d-flex align-items-center" href="#!" onClick={(event: any) => { event.preventDefault(); handleClick(item) }}>
                        ...
                        <Row className="g-4 mb-3">
                            ...
                            <Col lg={6}>
                                ...
                                >
                                    <option value="High">Inprogress</option>
            ...
            {/* Projects */}
            <Modal id="createProjectModal" show={modalProject} tabIndex={-1} centered>
                <Modal.Header onClick={() => setModalProject(!modalProject)} className="p-3 bg-success-subtle" id="createProjectModalLabel" closeButton>
                    <h5 className='modal-title'>
                ...
                <Modal.Body>
                    <form className="needs-validation createProject-form" onSubmit={(e) => {
                        ...
                        <div className="mb-4">
                            ...
                            <Form.Control type="text" className="form-control" id="projectname-input"
                                name='title'
                            ...
                            {projectValidation.touched.title && projectValidation.errors.title ? (
                                <Form.Control.Feedback type="invalid">{projectValidation.errors.title}</Form.Control.Feedback>
                            ) : null}

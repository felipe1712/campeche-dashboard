                                    ...
                                    <div className="live-preview">
                                        <div>
                                            ...
                                            <Row className="g-3">
                                                ...
                                                <Col lg={12}>
                                                    <Dropdown className="input-group">
                                                        <Dropdown.Toggle as="button" className="btn btn-outline-secondary dropdown-toggle material-shadow-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</Dropdown.Toggle>
                                                        <Dropdown.Menu>

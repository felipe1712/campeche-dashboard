            ...
            <div className="page-content">
                <div className="container-fluid">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                <Card.Header><h4 className="card-title mb-0">Choices</h4></Card.Header>
                                <Card.Body>
                                    <div>
                                        <div>
                                            <Row>
                                                ...
                                                <Col lg={4} md={6}>
                                                    <div className="mb-3">
                                                        <Form.Label htmlFor="choices-single-groups" className="form-label text-muted">Option
                                                            Groups</Form.Label>
                                                        <Select
                                                            value={selectedGroup}
                                                            // searchable
                                                ...
                                                <Col lg={4} md={6}>
                                                    <div className="mb-3">
                                                        <Form.Label htmlFor="choices-single-no-search" className="form-label text-muted">Options added
                                                            via config with no search</Form.Label>
                                                        <Select
                                                            isClearable={true}
                                                ...
                                                <Col lg={4} md={6}>
                                                    <div className="mb-3">
                                                        <Form.Label htmlFor="choices-single-no-sorting" className="form-label text-muted">Options added
                                                            via config with no sorting</Form.Label>
                                                        <Select
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <Row>
                                                ...
                                                <Col lg={4} md={6}>
                                                    <div className="mb-3">
                                                        <Form.Label htmlFor="choices-multiple-remove-button" className="form-label text-muted">With
                                                            remove button</Form.Label>
                                                        <Select
                                                ...
                                                <Col lg={4} md={6}>
                                                    <div className="mb-3">
                                                        <Form.Label htmlFor="choices-multiple-groups" className="form-label text-muted">Option
                                                            groups</Form.Label>
                                                        <Select

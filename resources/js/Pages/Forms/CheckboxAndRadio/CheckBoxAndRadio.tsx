                                ...
                                <Card.Body>
                                    ...
                                    <div className="live-preview">
                                        <div className="hstack gap-2 flex-wrap">
                                            ...
                                            <Form.Label className="btn btn-outline-primary material-shadow" htmlFor="btn-check-outlined">Single toggle</Form.Label>

                                            <Form.Control type="checkbox" className="btn-check" id="btn-check-2-outlined" defaultChecked />
                                            <Form.Label className="btn btn-outline-secondary material-shadow" htmlFor="btn-check-2-outlined">Checked</Form.Label>

                                            <Form.Control type="radio" className="btn-check" name="options-outlined" id="success-outlined" defaultChecked />
                                            <Form.Label className="btn btn-outline-success material-shadow" htmlFor="success-outlined">Checked success radio</Form.Label>

                                            <Form.Control type="radio" className="btn-check" name="options-outlined" id="danger-outlined" />
                                            <Form.Label className="btn btn-outline-danger material-shadow" htmlFor="danger-outlined">Danger radio</Form.Label>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ "height": "275px" }}>

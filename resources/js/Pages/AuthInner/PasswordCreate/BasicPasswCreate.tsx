                                        ...
                                        <Form onSubmit={validation.handleSubmit} action="/auth-signin-basic">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <div className="position-relative auth-pass-inputgroup mb-3">
                                                    ...
                                                    <Button variant="link" onClick={() => setConfrimPasswordShow(!confrimPasswordShow)} className="position-absolute end-0 top-0 text-decoration-none text-muted password-addon material-shadow-none" type="button">

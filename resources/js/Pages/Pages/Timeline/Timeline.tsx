                                ...
                                <div className="timeline">
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    ...
                                                    <div className="hstack gap-2">
                                                        <Link href="#" className="btn btn-sm btn-light"><span className="me-1">&#128293;</span> 19</Link>
                                                        <Link href="#" className="btn btn-sm btn-light"><span className="me-1">&#129321;</span> 22</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <Col sm={6}>
                                                    <div className="d-flex border border-dashed p-2 rounded position-relative">
                                                        ...
                                                        <div className="flex-grow-1 overflow-hidden ms-2">
                                                            <h6 className="text-truncate mb-0"><Link href="#" className="stretched-link">Business Template - UI/UX design</Link></h6>
                                                            <small>685 KB</small>
                                                        </div>
                                                    </div>
                                                </Col>
                                                <Col sm={6}>
                                                    <div className="d-flex border border-dashed p-2 rounded position-relative">
                                                        ...
                                                        <div className="flex-grow-1 ms-2 overflow-hidden">
                                                            <h6 className="mb-0 text-truncate"><Link href="#" className="stretched-link">Bank Management System - PSD</Link></h6>
                                                            <small>8.78 MB</small>
                                                        </div>
                                                    </div>
                                                </Col>
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="avatar-group mb-2">
                                                <Link href="#" className="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Christi">
                                                    <img src={avatar4} alt="" className="rounded-circle avatar-xs" />
                                                </Link>
                                                <Link href="#" className="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                                                    <img src={avatar3} alt="" className="rounded-circle avatar-xs" />
                                                </Link>
                                                <Link href="#" className="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title=" Ruby">
                                                ...
                                                <Link href="#" className="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="more">
                                                    <div className="avatar-xs">
                                    ...
                                    <div className="timeline-item right">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="hstack gap-2">
                                                <Link href="#" className="btn btn-sm bg-light"><span className="me-1">&#128151;</span> 35</Link>
                                                <Link href="#" className="btn btn-sm btn-light"><span className="me-1">&#128077;</span> 10</Link>
                                                <Link href="#" className="btn btn-sm btn-light"><span className="me-1">&#128591;</span> 10</Link>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="timeline-item right">
                                        ...
                                        <div className="content">
                                            ...
                                            <Link href="#" className="link-primary text-decoration-underline">Read More <i className="ri-arrow-right-line"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="timeline-2">
                                    <div className="timeline-year">
                                        <p className="material">12 Dec 2021</p>
                                    </div>
                                    <div className="timeline-continue">
                                            ...
                                            <Col xs={12}>
                                                <div className="timeline-box material-shadow">
                                                    <div className="timeline-text">
                                                        ...
                                                        <Row className="border border-dashed rounded gx-2 p-2">
                                                            <Col xs={3}>
                                                                <Link href="#"><img src={small7} alt="" className="img-fluid rounded material-shadow" /></Link>
                                                            </Col>
                                                            <Col xs={3}>
                                                                <Link href="#"><img src={small3} alt="" className="img-fluid rounded material-shadow" /></Link>
                                                            </Col>
                                                            <Col xs={3}>
                                                                <Link href="#"><img src={small10} alt="" className="img-fluid rounded material-shadow" /></Link>
                                                            </Col>
                                                            <Col xs={3}>
                                                                <Link href="#"><img src={small9} alt="" className="img-fluid rounded material-shadow" /></Link>
                                                            </Col>
                                                        </Row>
                                                    </div>
                                                </div>
                                        ...
                                        <Row>
                                            <Col xs={12}>
                                                <div className="timeline-year">
                                                    <p className="material">08 Dec 2021</p>
                                                </div>
                                            </Col>
                                        </Row>
                                    ...
                                    <div className="timeline-year">
                                        <p className="material"><span>05 Dec 2021</span></p>
                                    </div>

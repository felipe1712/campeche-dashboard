                            ...
                            <div>
                                <Tab.Container defaultActiveKey="overview">
                                    <div className="d-flex">
                                        <Nav className="animation-nav nav-pills profile-nav gap-2 gap-lg-3 flex-grow-1"
                                            role="tablist">
                                        ...
                                        <div className="flex-shrink-0">
                                            <Link href="/pages-profile-settings" className="btn btn-success"><i
                                                            ...
                                                            <div className="d-flex flex-wrap gap-2">
                                                                <div>
                                                                    <Link href="#" className="avatar-xs d-block">
                                                                        <span
                                                                            className="avatar-title rounded-circle fs-16 material-shadow bg-dark text-light">
                                                                ...
                                                                <div>
                                                                    <Link href="#" className="avatar-xs d-block">
                                                                        <span
                                                                            className="avatar-title rounded-circle fs-16 material-shadow bg-primary">
                                                                ...
                                                                <div>
                                                                    <Link href="#" className="avatar-xs d-block">
                                                                        <span
                                                                            className="avatar-title rounded-circle fs-16 material-shadow bg-success">
                                                                ...
                                                                <div>
                                                                    <Link href="#" className="avatar-xs d-block">
                                                                        <span
                                                                            className="avatar-title rounded-circle fs-16 material-shadow bg-danger">
                                                            ...
                                                            <div>
                                                                <div className="d-flex align-items-center py-3">
                                                                    ...
                                                                    <div className="flex-shrink-0 ms-2">
                                                                        <button type="button"
                                                                            className="btn btn-sm btn-outline-success material-shadow"><i
                                                                                            ...
                                                                                            <Accordion.Body
                                                                                                ...
                                                                                                <div className="avatar-group">
                                                                                                    <Link href="#"
                                                                                                        ...
                                                                                                        <img src={avatar4}
                                                                                                            alt=""
                                                                                                            className="rounded-circle material-shadow avatar-xs" />
                                                                                                    </Link>
                                                                                                    <Link href="#"
                                                                                                        className="avatar-group-item"
                                                                                                        data-bs-toggle="tooltip"
                                                                                                    ...
                                                                                                    <Link href="#"
                                                                                                        ...
                                                                                                        <div
                                                                                                            className="avatar-xs">
                                                                                                            <div
                                                                                                                className="avatar-title rounded-circle material-shadow bg-light text-primary">
                                                                                                                R
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </Link>
                                                                                                ...
                                                                                                <Link className="accordion-button p-2 shadow-none"
                                                                                                    ...
                                                                                                    <div className="d-flex">
                                                                                                        <div className="avatar-xs">
                                                                                                            <div
                                                                                                                className="avatar-title rounded-circle material-shadow bg-light text-danger">
                                                                                                                <i
                                                                                ...
                                                                                <div className="flex-grow-1">
                                                                                    <div
                                                                                        ...
                                                                                        <div className="avatar-group">
                                                                                            <div
                                                                                                className="avatar-group-item">
                                                                                                <div className="avatar-xs material-shadow">
                                                                                                    <img src={avatar4}
                                                                                                        alt=""
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div className="avatar-xs">
                                                                                                    <img src={avatar2}
                                                                                                        alt=""
                                                                                                        className="rounded-circle material-shadow img-fluid" />
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                    ...
                                                    <Row>
                                                        {(projects || []).map((item, key) => (
                                                            <Col xxl={3} sm={6} key={key}>
                                                                <Card className={`profile-project-card material-shadow shadow-none profile-project-${item.cardBorderColor}`}>
                                                                    <Card.Body className="p-4">
                                                                        <div className="d-flex">
                                                                            <div className="flex-grow-1 text-muted overflow-hidden">

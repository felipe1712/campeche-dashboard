                                            ...
                                            <Row className="g-2">
                                                <Col>
                                                    <div className="position-relative mb-3">
                                                        ...
                                                        <Link href="#" className="btn btn-link link-success btn-lg position-absolute end-0 top-0 material-shadow-none" onClick={toggleOffCanvas}><i className="ri-mic-fill"></i></Link>
                                                    </div>
                                                </Col>
                                ...
                                <Tab.Container defaultActiveKey={1}>
                                    ...
                                    <Card.Body className="p-4">
                                        <Tab.Content className="text-muted">
                                            <Tab.Pane eventKey={1}>
                                                <div className="pb-3">
                                                    <h5 className="mb-1"><Link href="#">Velzon - Responsive Bootstrap 5 Admin Dashboard</Link></h5>
                                                ...
                                                <div className="py-3">
                                                    <h5 className="mb-1"><Link href="#">Skote - Admin & Dashboard Template by Themesbrand</Link></h5>
                                                ...
                                                <div className="py-3">
                                                    <h5 className="mb-1"><Link href="#">Minia - React Js Admin & Dashboard Template</Link></h5>
                                                ...
                                                <div className="py-3">
                                                    <h5 className="mb-1"><Link href="#">Doson - Angular Admin & Dashboard Template by Themesbrand</Link></h5>
                                                    ...
                                                    {(video || []).map((item, key) => (
                                                        <Col lg={12} className="video-list" key={key}>
                                                            <div className="list-element mt-4">
                                                                <h5 className="mb-1"><Link href="#">{item.title}</Link></h5>

                            ...
                            <Row className="g-2">
                                ...
                                <Col className="col-sm-auto ms-auto">
                                    <div className="list-grid-nav hstack gap-1">
                                        ...
                                        <Button variant="info" id="grid-view-button" className="btn btn-soft-info nav-link btn-icon fs-14 active filter-button material-shadow-none"><i className="ri-grid-fill"></i></Button>
                                        <Button variant="info" id="list-view-button" className="btn btn-soft-info nav-link  btn-icon fs-14 filter-button material-shadow-none"><i className="ri-list-unordered"></i></Button>
                                        <Dropdown
                                            show={dropdownOpen}
                                            onClick={toggledropDown}>
                                            <Dropdown.Toggle type="button" className="btn btn-soft-info btn-icon fs-14 arrow-none material-shadow-none">
